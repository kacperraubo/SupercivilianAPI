...
from .constants import BASE_GEOCODING_API_URL, BASE_PLACES_API_URL
...
def generate_geocoding_api_url(url: str, **params: dict[str, typing.Any]) -> str:
    """Generate a URL for the Google Geocoding API.
    ...
    Returns:
        The generated URL.
    """
    return f"{BASE_GEOCODING_API_URL}{url}?{
        urllib.parse.urlencode(
            {
                **params,
                'key': settings.MAPS_PLATFORM_API_KEY,
